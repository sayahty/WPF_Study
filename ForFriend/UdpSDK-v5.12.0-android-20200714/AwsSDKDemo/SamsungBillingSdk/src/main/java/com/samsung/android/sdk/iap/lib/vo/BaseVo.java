...
public class BaseVo 
{
    ...
    public String dump()
    {
        ...
        try {
            ...
            jsonObject.put("mItemId",getItemId());
            jsonObject.put("mItemName",getItemName());
            jsonObject.put("mItemPrice",getItemPrice());
            jsonObject.put("mItemPriceString",getItemPriceString());
            jsonObject.put("mCurrencyUnit",getCurrencyUnit());
            jsonObject.put("mCurrencyCode",getCurrencyCode());
            jsonObject.put("mItemDesc",getItemDesc());
            jsonObject.put("mType",getType());
            jsonObject.put("mConsumableYN",getIsConsumable());
            dump = jsonObject.toString();
        } catch (JSONException e) {
            e.printStackTrace();
            dump = "{'mItemId':'"+getItemId()+"',"+
                    "'mItemName':'"+getItemName()+"',"+
                    "'mItemPrice':'"+getItemPrice()+"',"+
                    "'mItemPriceString':'"+getItemPriceString()+"',"+
                    "'mCurrencyUnit':'"+getCurrencyUnit()+"',"+
                    "'mCurrencyCode':'"+getCurrencyCode()+"',"+
                    "'mItemDesc':'"+getItemDesc()+"',"+
                    "'mType':'"+getType()+"',"+
                    "'mConsumableYN':'"+getIsConsumable()+"'"+
                    "'}";
