...
//        return dump;
        ...
        try {
            ...
            jsonObject.put("mStatusString",getStatusString());
            jsonObject.put("mStatusCode",getStatusCode());
            dump = jsonObject.toString();
        } catch (JSONException e) {
            e.printStackTrace();
            dump = "{'mPurchaseId':'"+getPurchaseId()+"',"+
                    "'mStatusString':'"+getStatusString()+"',"+
                    "'mStatusCode':'"+getStatusCode()+"'"+
                    "'}";
        }
        return dump;
    }
